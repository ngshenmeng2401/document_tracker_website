...
if (isset($_POST['changeProfile'])){
    ...
    if ($result->num_rows > 0){
        ...
        if($con->query($updateProfile) === TRUE)
        {
            ...
            echo "<script type='text/javascript'>alert('Success!');window.location.assign('admin_profile.php');</script>'";
        }else{
            echo "<script type='text/javascript'>alert('Failed!!');window.location.assign('admin_profile.php');</script>'";
        }
        
    }else{
        echo "<script type='text/javascript'>alert('No any record !!!');window.location.assign('admin_profile.php');</script>'";
    }
    ...
    if ($result->num_rows > 0){
        ...
        if($password != $confirmPassword or $confirmPassword != $password){
            ...
            echo "<script type='text/javascript'>alert('Both password are different !');window.location.assign('admin_profile.php');</script>'";
        }else{
    ...
    if ($_FILES["file"]["size"] > 3000000) {
        ...
        echo "<script type='text/javascript'>alert('Cant upload more than 3mb file !!!');window.location.assign('admin_profile.php');</script>'";
    }else{
                    ...
                    if ($result->num_rows > 0){
                        while ($row = $result -> fetch_assoc()){
                            ...
                            <li class="nav-item mt-1">
                                <a class="nav-link active" href="admin_profile.php"><?php echo $name; ?></a>
                            </li>
                            <?php
                        }
                    }
